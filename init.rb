...
Redmine::Plugin.register :redmine_issue_checklists do
  ...
  description 'Interactive checklists on Redmine issues — add items, toggle done, track progress. Community edition, free forever.'
  version RedmineIssueChecklists::VERSION
  url 'https://redmineshop.com/products/redmine-issue-checklists'
